...
## Evasion
Characters have *__Evasion__* as both a main form of effect mitigation and a secondary form of damage mitigation. Unlike **Defense**, *__Evasion__* is *strictly Global*; It takes effects whenever a character is defending against any **d% Check** and adds directly to that character's roll result. Additionally, *__Evasion__* scales as though it's an **Aptitude**; It has a fixed range of -50 to +50 and increments or decrements in **Boosts** and **Penalties** of 5. Finally, *__Evasion__* is optional; it's normally always applied to any effect you're defending against, as long as you can actively evade it, but you can always choose not to evade at all. Characters are initially created having 0 *__Evasion__*.
